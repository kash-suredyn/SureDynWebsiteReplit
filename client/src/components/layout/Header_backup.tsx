...
const Header = () => {
  ...
  const services = [
    { name: "Project Rescue Services", href: "/services/project-rescue", isKey: true },
  ...
  return (
    <header 
      className={cn(
        "bg-white shadow-lg sticky top-0 z-50 border-b border-gray-200 transition-all duration-300",
    ...
    >
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" role="navigation" aria-label="Main navigation">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-4 xl:space-x-6">
              ...
              <div className="relative group">
                ...
                <div className="absolute left-0 mt-2 w-80 bg-white dark:bg-gray-800 rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 border border-gray-200 dark:border-gray-700">
                  <div className="py-2">
                        ...
                        {solution.hasSubmenu ? (
                          <>
                            <Link href={solution.href}>
                              <span className="flex items-center justify-between px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-suredyn-orange-pale dark:hover:bg-suredyn-orange-pale hover:text-suredyn-orange-dark transition-colors duration-200 cursor-pointer">
                                {solution.name}
                                <i className="fas fa-chevron-right text-xs"></i>
                              </span>
                            </Link>
                            <div className="absolute left-full top-0 mt-0 w-80 bg-white dark:bg-gray-800 rounded-md shadow-lg opacity-0 invisible group-hover/sub:opacity-100 group-hover/sub:visible transition-all duration-200 border border-gray-200 dark:border-gray-700">
                              <div className="py-2">
                                {solution.submenu?.map((subItem) => (
                                  <Link key={subItem.href} href={subItem.href}>
                                    <span className="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-suredyn-orange-pale dark:hover:bg-suredyn-orange-pale hover:text-suredyn-orange-dark transition-colors duration-200 cursor-pointer">
                                      {subItem.name}
                                    </span>
                                  </Link>
                                ))}
                ...
                <button 
                  className={cn(
                    ...
                    isActivePath("/services") 
                      ? "text-suredyn-orange" 
                      : "text-gray-700 dark:text-gray-200 hover:text-suredyn-orange"
                  )}
                  aria-expanded="false" 
                  aria-haspopup="true"
                >
                      ...
                      <Link key={service.href} href={service.href}>
                        <span className={cn(
                          ...
                          service.isKey 
                            ...
                            : "text-gray-700 dark:text-gray-200 hover:bg-suredyn-orange-pale dark:hover:bg-suredyn-orange-pale hover:text-suredyn-orange-dark"
                        )}>
                          {service.name}
                        </span>
                      </Link>
              ...
              <div className="relative group">
                ...
                <div className="absolute left-0 mt-2 w-52 bg-white dark:bg-gray-800 rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 border border-gray-200 dark:border-gray-700">
                  <div className="py-2">
              ...
              <div className="relative group">
                ...
                <div className="absolute left-0 mt-2 w-56 bg-white dark:bg-gray-800 rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 border border-gray-200 dark:border-gray-700">
                  <div className="py-2">
                    <Link href="/blog">
                      <span className="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-suredyn-orange-pale dark:hover:bg-suredyn-orange-pale hover:text-suredyn-orange-dark transition-colors duration-200 cursor-pointer">
                        Blog
        ...
        <div className={cn("md:hidden transition-all duration-300 overflow-hidden", 
          ...
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-card dark:bg-card border-t border-border max-h-screen overflow-y-auto">
            
            {/* Home */}
            <Link href="/">
              <span className="text-gray-700 dark:text-gray-200 hover:text-suredyn-orange block px-3 py-2 text-base font-medium cursor-pointer">
                Home
              </span>
            </Link>
            ...
            <div>
              <button 
                ...
                className="w-full text-left text-gray-700 dark:text-gray-200 hover:text-suredyn-orange flex items-center justify-between px-3 py-2 text-base font-medium"
              >
                Solutions
